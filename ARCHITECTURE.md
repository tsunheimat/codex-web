...
duplicates. Replacing a socket within five minutes replays only messages the
peer has not acknowledged. The connection id and acknowledgement state live in
